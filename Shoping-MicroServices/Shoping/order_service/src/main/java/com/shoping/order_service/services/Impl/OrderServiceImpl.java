...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse placeOrder(OrderRequest orderRequest) {
        ...
        try {
            ...
            throw new CustomException("Connection to Product Service is failed, Try later",
                    "CONNECTION_TO_PRODUCT_SERVICE_FAILED");
        }
        ProductProxy product = productOptional.getBody();
        // validating the order
        if (product.getProdName() == null) {
            throw new CustomException("Product Does Not exists.", "PRODUCT_DOESN'T_NOT_EXISTS");
        }
        ...
        try {
            ...
            throw new CustomException("Connection to Product Service is failed _ qty",
                    "CONNECTION_TO_PRODUCT_SERVICE_FAILED");
        }
        try {
        ...
        try {
            ...
            throw new CustomException("Payment unsuccessfull1",
                    "PAYMENT_FAILED");
        }
